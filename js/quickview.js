          ...
          <div class="flex gap-2">
            ${colors
              .map((c) => {
                ...
                return `<button onclick="qvSetColor('${c}')" style="background:${v.colorHex}" class="h-7 w-7 rounded-full border-2 ${qvState.color === c ? "border-gold" : "border-transparent"}" aria-label="${c}"></button>`;
              })
              .join("")}
          </div>
        </div>
